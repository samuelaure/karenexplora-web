    ...
    const slides = [
        {
            content: (
                <div className={styles.grid}>
                    ...
                    <img src="https://karenexplora.com/media/slider-entrevista-cinco8.png" alt="Karen" className={styles.img} />
                </div>
            )
        },
        {
            content: (
                <div className={`${styles.grid} ${styles.reverse}`}>
                    ...
                    <img src="https://karenexplora.com/media/karen-brewer-cardenalito-venezuela.png" alt="Karen y Cardenalito" className={styles.img} />
                </div>
            )
        },
        {
            content: (
                <div className={styles.grid}>
                    ...
                    <img src="https://karenexplora.com/media/karen-brewer-premios-documentales.jpg" alt="Logros" className={styles.img} />
                </div>
            )
        },
        {
            content: (
                <div className={`${styles.grid} ${styles.reverse}`}>
                    ...
                    <img src="https://karenexplora.com/media/karen-john-brewer-familia.jpg" alt="Referentes" className={styles.img} />
                </div>
            )
        },
        {
            content: (
                <div className={styles.grid}>
                    ...
                    <img src="https://karenexplora.com/media/fanny-mendoza-madre.jpg" alt="Mamá" className={styles.img} />
                </div>
            )
        },
        {
        ...
        },
        {
            content: (
                <div className={`${styles.grid} ${styles.reverse}`}>
                    ...
                    <img src="https://karenexplora.com/media/karen-brewer-metas-educacion.jpg" alt="Metas" className={styles.img} />
                </div>
            )
        },
        {
