                        ...
                        {[
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-distintas-latitudes-karen.jpg",
                                buttonText: "Lee más"
                            },
                            {
                                title: "El Diario",
                                ...
                                image: "https://karenexplora.com/media/prensa-el-diario-karen.jpg",
                                buttonText: "Lee más"
                            },
                            {
                                title: "La tertulia",
                                ...
                                image: "https://karenexplora.com/media/prensa-la-tertulia.jpg",
                            ...
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-ararauna-charles-incendio.png",
                                buttonText: "Mira la entrevista"
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-hato-las-caretas.png",
                                buttonText: "Lee más"
                            },
                            {
                                title: "Agenda Exitos",
                                ...
                                image: "https://karenexplora.com/media/prensa-agenda-exitos.jpg",
                            ...
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-viajando-y-contando.png",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-catedra-del-pop.png",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                title: "Qué Vaina",
                                ...
                                image: "https://karenexplora.com/media/prensa-que-vaina.jpg",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                title: "UNIMET",
                                ...
                                image: "https://karenexplora.com/media/prensa-unimet-sustentabilidad.jpg",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-la-mega-ralph.jpg",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-arrobas-de-culto.jpg",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                title: "IFISA online",
                                ...
                                image: "https://karenexplora.com/media/prensa-ifisa-online.png",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                title: "cinco.8",
                                ...
                                image: "https://karenexplora.com/media/prensa-cinco8.png",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-dale-la-vuelta.png",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                ...
                                image: "https://karenexplora.com/media/prensa-onda-merida.png",
                                buttonText: "Haz clic aquí"
                            },
                            {
                                title: "Unión Radio",
                                ...
                                image: "https://karenexplora.com/media/prensa-union-radio-cuento.png",
                                buttonText: "Haz clic aquí"
                            }
                        ].map((item, index) => (
                ...
                <div className="container">
                    ...
                    <div className={styles.storiesGrid}>
                        ...
                        <FadeIn delay={0.1} className={styles.cardLight}>
                            <img src="https://karenexplora.com/media/cronica-sierra-imataca-incendio.jpg" alt="Sierra de Imataca" className={styles.cardImage} />
                            <div className={styles.cardContent}>
                        ...
                        <FadeIn delay={0.2} className={styles.cardLight}>
                            <img src="https://karenexplora.com/media/cronica-rescate-fauna-tocoma.png" alt="Rescate de fauna Tocoma" className={styles.cardImage} />
                            <div className={styles.cardContent}>
                        ...
                        <FadeIn delay={0.3} className={styles.cardLight}>
                            <img src="https://karenexplora.com/media/cronica-cueva-charles-brewer.jpg" alt="Cueva Charles Brewer" className={styles.cardImage} />
                            <div className={styles.cardContent}>
